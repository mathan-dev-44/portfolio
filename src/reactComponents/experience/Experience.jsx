              ...
              <div className="rounded-2xl border border-neutral-200 bg-white/80 p-4 shadow-sm backdrop-blur-sm transition hover:shadow-md dark:border-neutral-800 dark:bg-neutral-950/60 sm:p-6">
                ...
                <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between sm:gap-6">
                  ...
                  <div className="flex items-center gap-3">
                    {/* Logo box */}
                    <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-neutral-200 bg-white shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
                    ...
                    <div className="flex flex-col justify-center">
                      <h4 className="text-base font-semibold tracking-tight text-neutral-900 dark:text-white sm:text-lg leading-tight">
                        {exp.company}
                      </h4>
                    </div>
                  </div>
